...
namespace HiryuTK.AsteroidsTopDownController
{
    ...
    public class ObjectPoolManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            backgroundShip = new Pool(pf_backgroundShip, transform);
        ...
        public PoolObject SpawnBackgroundShip(Vector3 p, Quaternion r) => backgroundShip.Spawn(p, r);
