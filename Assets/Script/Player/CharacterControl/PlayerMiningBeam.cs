...
namespace HiryuTK.AsteroidsTopDownController
{
    public class PlayerMiningBeam : MonoBehaviour
    {
        ...
        private void ShootMiningBeam()
        {
            ...
            Vector2 shootDir = MouseWorldPosition.pos - player.ShootPoint.position;
            ...
            else
            {
                ...
                Debug.DrawLine(player.ShootPoint.position, MouseWorldPosition.pos, Color.blue, 1f);
                player.LineRenderer.SetPositions(new Vector3[] { player.ShootPoint.position, MouseWorldPosition.pos });
